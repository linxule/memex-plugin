...
from memex.scripts.utils import (
    ...
    format_frontmatter,
    # Unused here, deliberately kept: the scripts/ shim re-exports it, flat
    # importers already got it (as the buggy stub) before v0.16.3, and
    # tests/test_transcript_to_md_imports.py identity-pins it as the sentinel
    # for the shadowing bug this module used to carry.
    sanitize_project_name,  # noqa: F401
)
...
def convert_transcript_file(
    ...
    # Write output. Release-SOP write-gate audit (plugin-authoring.md): this is
